Shader "Custom/StandardRimRampDetailHatchingV2" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			half intensity = dot(o.Albedo.rgb, half3(0.3, 0.59, 0.11));
			o.Albedo *= (1.0 + Hatching(IN.uv_Hatch0, intensity).rgb * _HatchingPower);
